...
Inaktive oder eingestellte Projekte. Diese Ressourcen werden nicht mehr aktiv gepflegt, können aber für historische Referenzen oder als Inspiration nützlich sein.

Zurück zur [Hauptliste](README.md).
...
- 📜 [Bundesgit](https://bundestag.github.io/gesetze/) - Bundesgesetze und Verordnungen als Git-Repository im Markdown-Format (2012). [GitHub](https://github.com/bundestag/gesetze).
- ❓ [kleineAnfragen](https://kleineanfragen.de/) - Sammlung kleiner Anfragen aus Bundestag und Länderparlamenten (2015-2020). [GitHub](https://github.com/robbi5/kleineanfragen).
- ⚖️ [OffeneGesetze.de](https://offenegesetze.de/) - Freier Zugang zu Bundesgesetzblättern. [GitHub](https://github.com/bundestag/offenegesetze.de).
