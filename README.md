# awesome-bundestag [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) [![RSS](https://img.shields.io/badge/Subscribe-RSS-blue.svg)](https://github.com/tifa365/awesome-bundestag/commits/main.atom)

##### Kuratierte Liste von offenen Datenquellen, APIs, Tools, Anwendungen und Ressourcen zum Deutschen Bundestag.

Der Deutsche Bundestag ist eines der transparentesten Parlamente Europas. Diese Liste bündelt Datensätze, APIs, Tools und Anwendungen, die Bürgern, Forschern, Entwicklern und Journalisten helfen, Deutschlands Bundesparlament und demokratische Prozesse besser zu verstehen.

Etwas hinzuzufügen oder zu ändern? Öffne einen [Pull Request](../../pulls) oder ein [Issue](../../issues)!
...
Soweit gesetzlich möglich, haben die Mitwirkenden an dieser Liste auf alle Urheberrechte und verwandten Schutzrechte an diesem Werk verzichtet.

## Mitwirken

Beiträge sind willkommen! Bitte lies zunächst die [Contribution Guidelines](CONTRIBUTING.md).

Um einen neuen Eintrag hinzuzufügen:
1. Forke dieses Repository
2. Füge deinen Eintrag im passenden Abschnitt hinzu
3. Stelle sicher, dass Link und Beschreibung klar und prägnant sind
